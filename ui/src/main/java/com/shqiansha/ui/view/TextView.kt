...
class TextView : AppCompatTextView {
    ...
    private fun initAttr(attr: AttributeSet?) {
        ...
        val tlRadius = typedArray.getDimension(R.styleable.TextView_topLeftRadius, radius)
        val trRadius = typedArray.getDimension(R.styleable.TextView_topRightRadius, radius)
        val blRadius = typedArray.getDimension(R.styleable.TextView_bottomLeftRadius, radius)
        val brRadius = typedArray.getDimension(R.styleable.TextView_bottomRightRadius, radius)
